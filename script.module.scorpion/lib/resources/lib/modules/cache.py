...
def _find_cache_version():
    ...
    try:
        ...
        import xbmc
        print 'scorpion Addon Data Path Does not Exist. Creating Folder....'
        ad_folder = xbmc.translatePath('special://home/userdata/addon_data/plugin.video.scorpion')
    ...
    try:
        curVersion = control.addon('script.module.scorpion').getAddonInfo('version')
