...
class tvshows:
    def __init__(self):
        ...
        self.featured_link = 'https://api.trakt.tv/shows/watched/weekly'
    ...
    def networks(self):
        ...
        ('ABC', 'https://www.tvmaze.com/networks/3/abc', 'networks/abc.png'),
        ...
        ('Cinemax', 'http://api.trakt.tv/shows/popular?networks=Cinemax&limit=100&page=1', 'networks/cinemax.png'),
        ...
        ('FOX', 'https://www.imdb.com/search/title/?title_type=tv_series,tv_special,tv_miniseries,documentary,tv_short&companies=co0056447', 'networks/fox.png'),
        ('FX', 'https://www.imdb.com/search/title/?title_type=tv_series,tv_special,tv_miniseries,documentary,tv_short&companies=co0060381', 'networks/fx.png'),
        ('FXx', 'https://www.imdb.com/search/title/?title_type=tv_series,tv_special,tv_miniseries,documentary,tv_short&companies=co0421362', 'networks/fxx.png'),
        ...
        for i in networks: self.list.append({'name': i[0], 'url': i[1], 'image': i[2], 'action': 'tvshows'})
        self.addDirectory(self.list)
        return self.list
